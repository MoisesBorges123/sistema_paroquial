...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('estilo_painel\assets\icon\themify-icons\themify-icons.css')}}">
    <!-- ico font -->
...
<body class="fix-menu">
    ...
    <section class="login-block">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                <form class="md-float-material form-material" action="{{route('login.authenticate')}}" method="POST">
                    {{ csrf_field() }}
                        <div class="text-center">
                            <img src="{{asset('estilo_painel\assets\images\logo.png')}}" alt="logo.png">
                            <!--imagens\logo-power-software.png  -->
                        </div>
                        <div class="auth-box card">
                            <div class="card-block">
                                <div class="row m-b-20">
                                    <div class="col-md-12">
                                        <h3 class="text-center txt-primary">Fazer Login</h3>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-7">
                                        <p class="text-inverse text-left m-b-0">Seja bem vindo ao nosso sistema.</p>
                                        <p class="text-inverse text-left"><a href="index-1.htm"><b class="f-w-600">Voltar para o website</b></a></p>
                                    </div>
                                    <div class="col-md-5">
                                        <img src="{{asset('imagens\woli.png')}}" width='150' height="100" alt="small-logo.png">
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript" src="{{asset('estilo_painel\assets\js\common-pages.js')}}"></script>
