                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group form-primary">
                                            <input type="password" name="password_confirmation" class="form-control" required="" placeholder="Confirmar Senha">
                                            <span class="form-bar"></span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="checkbox-fade fade-in-primary">
                                            <label>
                                                ...
                                                <span class="text-inverse">Aceito que me envie email sobre noticias da paroquia.</span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
