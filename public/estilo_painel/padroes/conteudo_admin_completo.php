...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="../estilo_painel/assets/images/favicon.ico" type="image/x-icon">
    <!-- Google font-->
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:400,600" rel="stylesheet">
    <!-- Required Fremwork -->
    <link rel="stylesheet" type="text/css" href="../estilo_painel/bower_components/bootstrap/css/bootstrap.min.css">
    <!-- feather Awesome -->
    <link rel="stylesheet" type="text/css" href="../estilo_painel/assets/icon/feather/css/feather.css">
    <!-- Style.css -->
    <link rel="stylesheet" type="text/css" href="../estilo_painel/assets/css/style.css">
    <link rel="stylesheet" type="text/css" href="../estilo_painel/assets/css/jquery.mCustomScrollbar.css">
</head>
            ...
            <nav class="navbar header-navbar pcoded-header">
                <div class="navbar-wrapper">
                    ...
                    <div class="navbar-logo">
                        ...
                        <a href="index-1.htm">
                            <img class="img-fluid" src="../estilo_painel/assets/images/logo.png" alt="Theme-Logo">
                        </a>
                    ...
                    <div class="navbar-container container-fluid">
                        ...
                        <ul class="nav-right">
                            ...
                            <li class="user-profile header-notification">
                                <div class="dropdown-primary dropdown">
                                    <div class="dropdown-toggle" data-toggle="dropdown">
                                        <img src="../estilo_painel/assets/images/avatar-4.jpg" class="img-radius" alt="User-Profile-Image">
                                        <span>John Doe</span>
                            ...
                            <div class="main-friend-list">
                                <div class="media userlist-box" data-id="1" data-status="online" data-username="Josephin Doe" data-toggle="tooltip" data-placement="left" title="Josephin Doe">
                                    <a class="media-left" href="#!">
                                        <img class="media-object img-radius img-radius" src="../estilo_painel/assets/images/avatar-3.jpg" alt="Generic placeholder image ">
                                ...
                                <div class="media userlist-box" data-id="2" data-status="online" data-username="Lary Doe" data-toggle="tooltip" data-placement="left" title="Lary Doe">
                                    <a class="media-left" href="#!">
                                        <img class="media-object img-radius" src="../estilo_painel/assets/images/avatar-2.jpg" alt="Generic placeholder image">
                                        <div class="live-status bg-success"></div>
                                    </a>
                                    <div class="media-body">
                                ...
                                <div class="media userlist-box" data-id="3" data-status="online" data-username="Alice" data-toggle="tooltip" data-placement="left" title="Alice">
                                    <a class="media-left" href="#!">
                                        <img class="media-object img-radius" src="../estilo_painel/assets/images/avatar-4.jpg" alt="Generic placeholder image">
                                        <div class="live-status bg-success"></div>
                                    </a>
                                    <div class="media-body">
                                ...
                                <div class="media userlist-box" data-id="4" data-status="online" data-username="Alia" data-toggle="tooltip" data-placement="left" title="Alia">
                                    <a class="media-left" href="#!">
                                        <img class="media-object img-radius" src="../estilo_painel/assets/images/avatar-3.jpg" alt="Generic placeholder image">
                                        <div class="live-status bg-success"></div>
                                    </a>
                                    <div class="media-body">
                                                    ...
                                                    <div class="card-block">
                                                        <div class="row m-b-25">
                                                            <div class="col-auto p-r-0">
                                                                <div class="u-img">
                                                                    <img src="../estilo_painel/assets/images/breadcrumb-bg.jpg" alt="user image" class="img-radius cover-img">
                                                                    <img src="../estilo_painel/assets/images/avatar-2.jpg" alt="user image" class="img-radius profile-img">
                                                                </div>
                                                            </div>
                                                            <div class="col">
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="b-none">
                                                                                        ...
                                                                                        <img src="../estilo_painel/assets/images/avatar-2.jpg" alt="user image" class="img-radius img-40 align-top m-r-15">
...
<![endif]-->
    ...
    <script type="text/javascript" src="../estilo_painel/bower_components/jquery/js/jquery.min.js"></script>
    <script type="text/javascript" src="../estilo_painel/bower_components/jquery-ui/js/jquery-ui.min.js"></script>
    <script type="text/javascript" src="../estilo_painel/bower_components/popper.js/js/popper.min.js"></script>
    <script type="text/javascript" src="../estilo_painel/bower_components/bootstrap/js/bootstrap.min.js"></script>
    <!-- jquery slimscroll js -->
    <script type="text/javascript" src="../estilo_painel/bower_components/jquery-slimscroll/js/jquery.slimscroll.js"></script>
    <!-- modernizr js -->
    <script type="text/javascript" src="../estilo_painel/bower_components/modernizr/js/modernizr.js"></script>
    <!-- Chart js -->
    <script type="text/javascript" src="../estilo_painel/bower_components/chart.js/js/Chart.js"></script>
    <!-- amchart js -->
    <script src="../estilo_painel/assets/pages/widget/amchart/amcharts.js"></script>
    <script src="../estilo_painel/assets/pages/widget/amchart/serial.js"></script>
    <script src="../estilo_painel/assets/pages/widget/amchart/light.js"></script>
    <script src="../estilo_painel/assets/js/jquery.mCustomScrollbar.concat.min.js"></script>
    <script type="text/javascript" src="../estilo_painel/assets/js/SmoothScroll.js"></script>
    <script src="../estilo_painel/assets/js/pcoded.min.js"></script>
    <!-- custom js -->
    <script src="../estilo_painel/assets/js/vartical-layout.min.js"></script>
    <script type="text/javascript" src="../estilo_painel/assets/pages/dashboard/custom-dashboard.js"></script>
    <script type="text/javascript" src="../estilo_painel/assets/js/script.min.js"></script>
