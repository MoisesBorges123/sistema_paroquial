                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="pcoded-hasmenu">
                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class=" ">
                                            <a href="../../cadastros/livros_registros/cadastrar.php">
                                                <span class="pcoded-mtext">Novo Livro</span>
                                            </a>
                                        </li>
                                        <li class=" ">
                                            <a href="../../cadastros/folhas_livros_registros/cadastrar.php">
                                                <span class="pcoded-mtext">Nova Folha</span>
                                            </a>
                                        </li>
                                        <li class=" ">
                                            <a href="../../visualizacoes/meu_livro/livros.php">
                                                <span class="pcoded-mtext">Meus Livros</span>
                                            </a>
                                        </li>
                                        <li class=" ">
                                            <a href="form-elements-advance.htm">
                                                <span class="pcoded-mtext">Novo Batismo</span>
                                            </a>
                                        </li>
                                        <li class=" ">
                                            <a href="form-validation.htm">
                                                <span class="pcoded-mtext">Novo Casamento</span>
                                            </a>
                                        </li>
                                        <li class=" ">
                                            <a href="form-validation.htm">
                                                <span class="pcoded-mtext">Nova Crisma</span>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
