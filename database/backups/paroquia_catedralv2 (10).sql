...
--
-- Host: 127.0.0.1
-- Generation Time: 05-Fev-2020 às 11:29
...
INSERT INTO `devolucoes` (`id_devolucao`, `dizimista`, `data_dev`, `valor`, `ano_ref`, `mes_ref`, `local_dev`) VALUES
(1, 2, 2020, 20, 2019, 4, 1);
...
--
ALTER TABLE `pessoas`
  MODIFY `id_pessoa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;
...
--
ALTER TABLE `telefones`
  MODIFY `id_telefone` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
