...
--
-- Table structure for table `base_de_precos_estacionamento`
--

CREATE TABLE `base_de_precos_estacionamento` (
  `id_base_preco` int(11) NOT NULL,
  `data` date NOT NULL,
  `descricao` varchar(300) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `base_de_precos_estacionamento`
--

INSERT INTO `base_de_precos_estacionamento` (`id_base_preco`, `data`, `descricao`) VALUES
(1, '2020-03-28', NULL),
(2, '2020-03-28', NULL),
(3, '2020-03-28', NULL);
...
--
-- Table structure for table `batizado`
--
...
--
-- Table structure for table `batizando`
--
...
--
-- Table structure for table `batizando_telefone`
--
...
--
-- Table structure for table `capelas`
--
...
--
-- Dumping data for table `capelas`
--
...
--
-- Stand-in structure for view `carros_estacionamento`
-- (See below for the actual view)
--
CREATE TABLE `carros_estacionamento` (
`id_fluxo` int(11)
,`carro` int(11)
...
--
-- Table structure for table `casamentos`
--
...
--
-- Table structure for table `catequese_inscricoes`
--
...
--
-- Table structure for table `clero_igreja`
--
...
--
-- Table structure for table `componentes_pastorais`
--
...
INSERT INTO `computadores` (`id_computador`, `ip`, `nome`, `senha`, `descricao`, `mac`, `sistema_operacional`, `tipo`, `marca`) VALUES
(1, '127.0.0.1', 'Servidor', 'Não Possui', NULL, NULL, 'Windows 10', 'Computador', 'Desconhecida'),
(2, '10.0.0.14', 'Diretoria', 'Não Possui', NULL, NULL, 'Windows 10', 'Computador', 'Asus'),
(3, '10.0.0.121', 'Estacionamento', 'Não Possui', NULL, NULL, 'Windows 10', 'Computador', 'Lenovo'),
(15, '192.168.1.160', 'Salão Paroquial', NULL, NULL, NULL, 'Windows 10', 'Computador', 'Samsung');
...
--
-- Table structure for table `conselho_pessoa`
--
...
--
-- Table structure for table `crisma`
--
...
--
-- Table structure for table `cursos_ofertados`
--
...
INSERT INTO `devolucoes` (`id_devolucao`, `dizimista`, `valor`, `ano_ref`, `mes_ref`, `local_dev`, `created_at`, `updated_at`) VALUES
(1, 2, 70, 2019, 4, '1', '0000-00-00 00:00:00', '2020-02-09 14:57:48'),
(2, 2, 24, 2019, 1, '127.0.0.1', '2020-02-09 14:45:18', '2020-02-09 14:45:18'),
(3, 12, 30, 2020, 1, '127.0.0.1', '2020-02-09 14:59:15', '2020-02-09 14:59:15');
...
INSERT INTO `dizimistas` (`id_dizimista`, `pessoa`, `d_cadastro`, `situacao`) VALUES
(2, 56, '2019-12-18', 3),
(3, 57, '2019-12-18', 3),
(4, 58, '2019-12-18', 3),
(12, 55, '2020-01-06', 3),
...
(2, 2, '816', NULL, NULL, NULL),
(3, 2, '816', NULL, NULL, NULL),
(4, 2, '816', NULL, NULL, NULL),
(5, 2, '816', NULL, NULL, NULL),
(6, 2, '816', NULL, NULL, NULL),
(7, 2, '816', NULL, NULL, NULL),
(8, 2, '816', NULL, NULL, NULL),
(9, 2, '816', NULL, NULL, NULL),
(10, 2, '816', NULL, NULL, NULL),
(11, 2, '816', NULL, NULL, NULL),
(12, 2, '816', '101', NULL, NULL),
(13, 2, '816', NULL, NULL, NULL),
(14, 2, '816', '10', NULL, NULL),
(15, 2, '814', NULL, NULL, NULL),
(16, 2, '56', NULL, NULL, NULL),
(17, 5, '3434', NULL, NULL, NULL),
(18, 2, '123', NULL, NULL, NULL),
(19, 5, '22343', NULL, NULL, NULL),
(20, 2, '12', NULL, NULL, NULL),
(21, 2, '816', NULL, NULL, NULL),
(22, 12, '123', NULL, NULL, NULL),
(23, 5, '123', NULL, NULL, NULL),
(24, 12, '456', NULL, NULL, NULL),
(25, 12, '456', NULL, NULL, NULL),
(26, 12, '456', NULL, NULL, NULL),
(27, 12, '456', NULL, NULL, NULL),
(28, 12, '456', NULL, NULL, NULL),
(29, 2, '34', NULL, NULL, NULL),
(30, 2, '12', NULL, NULL, NULL),
(31, 2, '123', NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `escritorio_visita_estacioanamento`
--

CREATE TABLE `escritorio_visita_estacioanamento` (
...
(28, 'Paraná', 'PR'),
(29, 'Pernambuco', 'PE'),
(32, 'Rio Grande do Norte', 'RN'),
(33, 'Rio Grande do Sul', 'RS'),
(34, 'Rondônia', 'RO'),
(35, 'Roraima', 'RR'),
(36, 'Santa Catarina', 'SC'),
(38, 'Sergipe', 'SE'),
(39, 'Tocantins', 'TO');
...
--
-- Table structure for table `etapas_catequese`
--
...
--
-- Table structure for table `fluxo_diario`
--
...
--
-- Dumping data for table `fluxo_diario`
--

INSERT INTO `fluxo_diario` (`id_fluxo`, `carro`, `pagamento`, `horario`) VALUES
(10, 31, 10, 10),
(11, 32, 11, 11),
(12, 33, 12, 12),
(13, 34, 13, 13),
...
--
-- Table structure for table `folhas`
--
...
--
-- Table structure for table `fotos_folhas`
--
...
--
-- Dumping data for table `fotos_folhas`
--
...
--
-- Table structure for table `horario_estacionamento`
--

CREATE TABLE `horario_estacionamento` (
  `id_horario` int(11) NOT NULL,
  `hora_entrada` int(11) NOT NULL,
  `hora_saida` int(11) DEFAULT NULL,
  `min_entrada` int(11) NOT NULL,
  `min_saida` int(11) DEFAULT NULL,
  `data_entrada` date NOT NULL,
  `data_saida` date DEFAULT NULL,
  `escritorio` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `horario_estacionamento`
--

INSERT INTO `horario_estacionamento` (`id_horario`, `hora_entrada`, `hora_saida`, `min_entrada`, `min_saida`, `data_entrada`, `data_saida`, `escritorio`) VALUES
(10, 15, NULL, 55, NULL, '2020-04-02', NULL, NULL),
(11, 17, NULL, 55, NULL, '2020-04-02', NULL, NULL),
(12, 12, NULL, 55, NULL, '2020-04-02', NULL, NULL),
(13, 11, NULL, 27, NULL, '2020-04-02', NULL, NULL),
(14, 11, NULL, 28, NULL, '2020-04-02', NULL, NULL),
(15, 11, NULL, 39, NULL, '2020-04-02', NULL, NULL),
(16, 11, NULL, 57, NULL, '2020-04-02', NULL, NULL),
(17, 7, NULL, 41, NULL, '2020-04-03', NULL, NULL),
(18, 15, NULL, 47, NULL, '2020-04-03', NULL, NULL),
(19, 15, NULL, 47, NULL, '2020-04-03', NULL, NULL),
(30, 12, NULL, 0, NULL, '2020-04-03', NULL, NULL),
(44, 15, NULL, 56, NULL, '2020-04-15', NULL, NULL),
(45, 15, NULL, 58, NULL, '2020-04-15', NULL, NULL),
(46, 15, NULL, 58, NULL, '2020-04-15', NULL, NULL),
(47, 16, NULL, 0, NULL, '2020-04-15', NULL, NULL);
...
INSERT INTO `intencao` (`id_intencao`, `intencao`, `solicitante`, `marcado_por`, `telefone`, `data_inicio`, `data_fim`, `tipo`, `horario`, `created_at`, `updated_at`) VALUES
(1, 'Teste', 'teste', NULL, '(23) 4232-4243', '2020-03-30', '2020-03-30', 2, '12:12', '2020-03-30 16:18:34', '2020-03-30 16:18:34');

-- --------------------------------------------------------

--
-- Table structure for table `lista_presenca_catequese`
--
...
--
-- Table structure for table `lista_presenca_cursos`
--
...
(2, 'Avenida Luiz Boali Porto Salman', 'Centro', '39802-000', 'Teófilo Otoni', 7),
(3, 'Avenida Luiz Boali Porto Salman', 'Centro', '39802-000', 'Teófilo Otoni', 7),
(4, 'Rua Antônio Alves Benjamim', 'Centro', '39800-021', 'Teófilo Otoni', 7),
(5, 'Avenida Alfredo Sá', 'Jardim das Acácias', '39803-000', 'Teófilo Otoni', 7),
(6, 'Rua Tonico Fernandes', 'Altino Barbosa', '39800-058', 'Teófilo Otoni', 7),
(12, 'Rua Ana Amália', 'Altino Barbosa', '39800-060', 'Teófilo Otoni', 7);

-- --------------------------------------------------------

--
-- Stand-in structure for view `mensalistas`
-- (See below for the actual view)
--
...
--
-- Stand-in structure for view `meus_dizimistas`
-- (See below for the actual view)
--
CREATE TABLE `meus_dizimistas` (
`id_dizimista` int(11)
,`pessoa` int(11)
,`d_cadastro` date
,`situacao` int(11)
...
--
-- Table structure for table `noivos_telefone`
--
...
--
-- Table structure for table `pagamentos_estacionamento`
--
...
CREATE TABLE `pagamentos_estacionamento` (
  ...
  `justificativa_desconto` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `pagamentos_estacionamento`
--

INSERT INTO `pagamentos_estacionamento` (`id_pagamento`, `valor`, `desconto`, `justificativa_desconto`, `base_calculo`, `pago`, `data_pagamento`, `modalidade`) VALUES
(10, NULL, NULL, NULL, 3, NULL, NULL, 'hora'),
(11, NULL, NULL, NULL, 3, NULL, NULL, 'hora'),
(12, NULL, NULL, NULL, 3, NULL, NULL, 'hora'),
(13, NULL, NULL, NULL, 3, NULL, NULL, 'hora'),
(14, NULL, NULL, NULL, 3, NULL, NULL, 'hora'),
(15, NULL, NULL, NULL, 3, NULL, NULL, 'hora'),
(16, NULL, NULL, NULL, 3, NULL, NULL, 'hora'),
(17, NULL, NULL, NULL, 3, NULL, NULL, 'hora'),
(18, NULL, NULL, NULL, 3, NULL, NULL, 'hora'),
(19, NULL, NULL, NULL, 3, NULL, NULL, 'diaria'),
(30, NULL, NULL, NULL, 3, NULL, NULL, 'hora'),
(44, NULL, NULL, NULL, 3, NULL, NULL, 'hora'),
(45, NULL, NULL, NULL, 3, NULL, NULL, 'hora'),
(46, NULL, NULL, NULL, 3, NULL, NULL, 'hora'),
(47, NULL, NULL, NULL, 3, NULL, NULL, 'hora');

-- --------------------------------------------------------

--
-- Table structure for table `pastorais_movimentos_grupos`
--
...
CREATE TABLE `pessoas` (
  ...
  `observacoes_pessoa` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `pessoas` (`id_pessoa`, `nome`, `endereco`, `d_nasc`, `email`, `sexo`, `observacoes_pessoa`) VALUES
(55, 'Moisés Alves Borges', 11, '2020-01-30', 'moisesalvesborges@gmai.com', 1, NULL),
(56, 'Moisés Alves', 12, '1989-12-01', 'moisesalvesborges@gmai.com', 3, NULL),
(57, 'Patrícia', 13, '1997-11-06', 'moisesalvesborges@gmai.com', 2, NULL),
(58, 'Ilza', 14, '1997-11-06', 'moisesalvesborges@gmai.com', 2, NULL),
(72, 'Patricia Alves Borges', NULL, NULL, 'patriciaborgesteo@gmail.com', 2, NULL),
(74, 'Teste 6', 17, '2020-04-10', NULL, NULL, NULL),
(75, 'UPDATE', 18, '2020-04-18', 'null', NULL, NULL),
(76, 'Teste 8', 19, '2020-04-18', NULL, NULL, NULL),
(77, 'Teste 9', 20, '2020-04-18', NULL, NULL, NULL),
(78, 'Andreia Alves Borges', 21, '1986-10-07', NULL, NULL, NULL),
(79, 'Asdfasdfasd', 22, '2020-04-15', NULL, NULL, NULL),
(80, 'Asfasdfasdfa', 23, '2020-04-14', NULL, NULL, NULL),
(81, 'Teste 11', 24, '2020-04-15', NULL, NULL, NULL),
(82, 'Teste 11', 25, '2020-04-15', NULL, NULL, NULL),
(83, 'Teste 11', 26, '2020-04-15', NULL, NULL, NULL),
(84, 'Teste 11', 27, '2020-04-15', NULL, NULL, NULL),
(85, 'Teste 11', 28, '2020-04-15', NULL, NULL, NULL),
(86, 'Teste 90', 29, '2020-04-19', NULL, NULL, NULL),
(87, 'Xxxxxxxxxxxxx', 30, '2020-04-19', NULL, NULL, NULL),
(88, 'Yyyyyy', 31, '2020-04-19', NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `precos_estacionamento`
--

CREATE TABLE `precos_estacionamento` (
  ...
  `tipo_veiculo` varchar(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `precos_estacionamento`
--

INSERT INTO `precos_estacionamento` (`id_preco`, `preco`, `created_at`, `updated_at`, `usuario`, `computador`, `descricao`, `base`, `tipo_veiculo`) VALUES
(1, 2, '2020-03-28 21:25:47', '2020-03-29 00:34:25', NULL, '1', 'hora', 3, 'M'),
(2, 1, '2020-03-28 21:25:47', '2020-03-28 21:25:47', NULL, '1', '30min', 3, 'M'),
(3, 1, '2020-03-28 21:25:47', '2020-03-29 00:37:28', NULL, '1', '15min a 30min', 3, 'M'),
(4, 20, '2020-03-28 21:25:47', '2020-03-28 21:25:47', NULL, '1', 'diaria', 3, 'M'),
(5, 20, '2020-03-28 21:25:47', '2020-03-29 00:38:29', NULL, '1', 'pernoite', 3, 'M'),
(6, 3, '2020-03-28 21:25:47', '2020-04-03 22:55:40', NULL, '1', 'hora', 3, 'C'),
(7, 2, '2020-03-28 21:25:47', '2020-03-28 21:25:47', NULL, '1', '30min', 3, 'C'),
(8, 1, '2020-03-28 21:25:47', '2020-03-28 21:25:47', NULL, '1', '15min a 30min', 3, 'C'),
(9, 20, '2020-03-28 21:25:47', '2020-03-28 21:25:47', NULL, '1', 'diaria', 3, 'C'),
(10, 25, '2020-03-28 21:25:47', '2020-03-29 00:38:20', NULL, '1', 'pernoite', 3, 'C'),
(11, 160, '2020-03-28 21:25:47', '2020-03-28 21:25:47', NULL, '1', 'mensalidade', 3, 'C'),
(12, 50, '2020-03-28 21:25:47', '2020-03-29 00:38:41', NULL, '1', 'mensalidade', 3, 'M');

-- --------------------------------------------------------

--
-- Stand-in structure for view `registros_pessoas`
-- (See below for the actual view)
--
CREATE TABLE `registros_pessoas` (
`id_pessoa` int(11)
,`nome` varchar(255)
,`endereco` int(11)
,`d_nasc` date
,`email` varchar(255)
,`sexo` int(11)
,`observacoes_pessoa` varchar(255)
,`id_telefone` int(11)
,`dd` varchar(5)
,`numero` varchar(50)
,`obs` varchar(500)
...
INSERT INTO `telefones` (`id_telefone`, `dd`, `numero`, `obs`, `pessoa`) VALUES
(39, '33', '(33) 98735-6018', NULL, 56),
(40, '33', '(33) 98735-6018', NULL, 57),
(41, '33', '(33) 98735-6018', NULL, 58),
(50, '33', '(33) 98735-6018', NULL, 55),
(51, '33', '(33) 98735-6018', NULL, 59),
(52, '33', '(33) 98735-6018', 'x', 60),
(54, NULL, '(33) 98409-8250', NULL, 72),
(61, NULL, '(22) 2222-2222', NULL, 85),
(62, NULL, '(11) 1111-1111', NULL, 85),
(63, NULL, '(11) 1111-1111', NULL, 86),
(64, NULL, '(33) 3333-3333', NULL, 87),
(65, NULL, '(33) 3521-5575', NULL, 88);

-- --------------------------------------------------------

--
-- Table structure for table `tipos_intencao`
--
...
--
-- Dumping data for table `tipos_intencao`
--

INSERT INTO `tipos_intencao` (`id_tipo`, `nome`, `descricao`, `linhas_a_mais`, `situacao`) VALUES
(2, '7º Dia de Falecimento', 'Utilizado após 7 dias e falecimento', 3, 1),
(3, 'Ação de Graças', 'Missas de Aniversários, conclusão de curso ou graças alcançadas', 5, 1);

-- --------------------------------------------------------

--
-- Table structure for table `titulos_clero`
--
...
--
-- Dumping data for table `titulos_clero`
--
...
INSERT INTO `veiculos` (`id_veiculo`, `modelo`, `placa`, `cor`, `pessoa`, `descricao`, `isencao`, `situacao`, `tipo`) VALUES
(1, NULL, 'htt-3432', NULL, NULL, NULL, 0, NULL, 'c'),
(2, NULL, 'htt-3432', NULL, NULL, NULL, 0, NULL, 'c'),
(3, NULL, 'thy-2342', NULL, NULL, NULL, 0, NULL, 'C'),
(4, NULL, 'XXX-2343', NULL, NULL, NULL, 0, NULL, 'C'),
(5, NULL, 'XXX-2348', NULL, NULL, NULL, 0, NULL, 'C'),
(6, NULL, 'XXX-2342', NULL, NULL, NULL, 0, NULL, 'C'),
(7, NULL, 'XXX-2341', NULL, NULL, NULL, 0, NULL, 'C'),
(8, NULL, 'REA-2342', NULL, NULL, NULL, 0, NULL, 'C'),
(9, NULL, 'REA-2346', NULL, NULL, NULL, 0, NULL, 'C'),
(10, NULL, 'REA-2345', NULL, NULL, NULL, 0, NULL, 'C'),
(11, NULL, 'REA-2344', NULL, NULL, NULL, 0, NULL, 'C'),
(12, NULL, 'AAA-1111', NULL, 72, NULL, 0, NULL, 'C'),
(13, NULL, 'AAA-1112', NULL, NULL, NULL, 0, NULL, 'C'),
(14, NULL, 'AAA-1113', NULL, 72, NULL, 0, NULL, 'C'),
(15, NULL, 'AAA-1114', NULL, NULL, NULL, 0, NULL, 'C'),
(16, NULL, 'AAA-1115', NULL, NULL, NULL, 0, NULL, 'C'),
(17, NULL, 'AAA-1116', NULL, NULL, NULL, 0, NULL, 'C'),
(18, NULL, 'AAA-1117', NULL, 55, NULL, 0, NULL, 'C'),
(19, NULL, 'AAA-1118', NULL, NULL, NULL, 0, NULL, 'C'),
(20, NULL, 'AAA-1119', NULL, NULL, NULL, 0, NULL, 'C'),
(21, NULL, 'AAA-1120', NULL, NULL, NULL, 0, NULL, 'C'),
(22, NULL, 'AAA-0000', NULL, 55, NULL, 0, NULL, 'C'),
(23, NULL, 'AAA-0001', NULL, NULL, NULL, 0, NULL, 'C'),
(24, NULL, 'AAA-0020', NULL, NULL, NULL, 0, NULL, 'C'),
(25, NULL, 'AAA-0021', NULL, NULL, NULL, 0, NULL, 'C'),
(26, NULL, 'AAA-0022', NULL, NULL, NULL, 0, NULL, 'C'),
(27, NULL, 'AAA-0002', NULL, 58, NULL, 0, NULL, 'C'),
(28, NULL, 'AAA-0003', NULL, NULL, NULL, 0, NULL, 'C'),
(29, NULL, 'AAA-0004', NULL, 58, NULL, 0, NULL, 'C'),
(30, NULL, 'AAA-0005', NULL, NULL, NULL, 0, NULL, 'C'),
(31, NULL, 'AAA-0006', NULL, NULL, NULL, 0, NULL, 'C'),
(32, NULL, 'AAA-0007', NULL, NULL, NULL, 0, NULL, 'C'),
(33, NULL, 'AAA-0008', NULL, NULL, NULL, 0, NULL, 'C'),
(34, NULL, 'AAA-3W34', NULL, NULL, NULL, 0, NULL, 'C'),
(35, NULL, 'AAA-0009', NULL, 55, NULL, 0, NULL, 'C'),
(36, NULL, 'AAA-3434', NULL, NULL, NULL, 0, NULL, 'C'),
(37, NULL, 'AAA-0089', NULL, NULL, NULL, 0, NULL, 'C'),
(38, NULL, 'AAA-5555', NULL, NULL, NULL, 0, NULL, 'C'),
(39, NULL, 'AAA-2343', NULL, NULL, NULL, 0, NULL, 'C'),
(40, NULL, 'AAA-2342', NULL, NULL, NULL, 0, NULL, 'C'),
(41, NULL, 'ASF-2232', NULL, NULL, NULL, 0, NULL, 'M'),
(42, NULL, 'ASF-2223', NULL, NULL, NULL, 0, NULL, 'M'),
(43, NULL, '233-2423', NULL, 55, NULL, 0, NULL, 'M'),
(44, NULL, 'ASA-2324', NULL, NULL, NULL, 0, NULL, 'M'),
(45, NULL, 'ASF-2434', NULL, NULL, NULL, 0, NULL, 'M'),
(46, NULL, 'ASD-2343', NULL, NULL, NULL, 0, NULL, 'M'),
(47, NULL, 'GSF-2343', NULL, NULL, NULL, 0, NULL, 'M'),
(48, NULL, 'ASF-3244', NULL, NULL, NULL, 0, NULL, 'M'),
(49, NULL, 'ASD-5443', NULL, NULL, NULL, 0, NULL, 'M'),
(50, NULL, 'AWD-2343', NULL, 55, NULL, 0, NULL, 'M'),
(51, NULL, 'ASF-2343', NULL, NULL, NULL, 0, NULL, 'M'),
(52, NULL, 'ASD-2433', NULL, NULL, NULL, 0, NULL, 'M'),
(53, NULL, 'ASD-1111', NULL, NULL, NULL, 0, NULL, 'M'),
(55, NULL, 'XXX-2344', NULL, NULL, NULL, 0, NULL, 'C'),
(56, NULL, 'TTT-2343', NULL, NULL, NULL, 0, NULL, 'C'),
(57, NULL, 'TRE-3433', NULL, NULL, NULL, 0, NULL, 'C'),
(58, NULL, 'YYY-1231', NULL, NULL, NULL, 0, NULL, 'C'),
(59, NULL, 'TWR-1232', NULL, NULL, NULL, 0, NULL, 'C'),
(60, NULL, '123-1311', NULL, NULL, NULL, 0, NULL, 'C'),
(61, NULL, 'ADF-2343', NULL, NULL, NULL, 0, NULL, 'C'),
(62, NULL, 'ASQ-2433', NULL, NULL, NULL, 0, NULL, 'C'),
(63, NULL, 'BAA-1111', NULL, NULL, NULL, 0, NULL, 'C'),
(64, NULL, 'BAA-1117', NULL, NULL, NULL, 0, NULL, 'C'),
(65, NULL, 'BAA-0000', NULL, NULL, NULL, 0, NULL, 'C'),
(66, NULL, 'ABA-0000', NULL, NULL, NULL, 0, NULL, 'C'),
(67, NULL, 'AAB-0000', NULL, NULL, NULL, 0, NULL, 'C'),
(68, NULL, 'AAV-0000', NULL, NULL, NULL, 0, NULL, 'C'),
(69, NULL, 'AHA-0000', NULL, NULL, NULL, 0, NULL, 'C'),
(70, NULL, 'AKA-0000', NULL, NULL, NULL, 0, NULL, 'C'),
(71, NULL, 'BHT-0000', NULL, NULL, NULL, 0, NULL, 'C'),
(72, NULL, 'GXH-0001', NULL, 55, NULL, 0, NULL, 'C'),
(73, NULL, 'YYE-2423', NULL, 55, NULL, 0, NULL, 'M'),
(74, NULL, 'AAA-0000', NULL, NULL, NULL, 0, NULL, 'M'),
(75, NULL, 'AAA-1111', NULL, NULL, NULL, 0, NULL, 'M'),
(76, NULL, 'XXX-4444', NULL, NULL, NULL, 0, NULL, 'C'),
(77, NULL, 'UUU-9999', NULL, NULL, NULL, 0, NULL, 'C'),
(78, NULL, 'JJJ-8888', NULL, NULL, NULL, 0, NULL, 'C'),
(79, NULL, 'EEE-4544', NULL, NULL, NULL, 0, NULL, 'M'),
(80, NULL, 'EEE-4544', NULL, NULL, NULL, 0, NULL, 'C');

-- --------------------------------------------------------

--
-- Stand-in structure for view `v_horarios_estacionamento`
-- (See below for the actual view)
--
CREATE TABLE `v_horarios_estacionamento` (
`id_horario` int(11)
,`hora_entrada` int(11)
,`hora_saida` int(11)
,`min_entrada` int(11)
...
--
-- Stand-in structure for view `v_pessoas`
-- (See below for the actual view)
--
...
--
-- Structure for view `carros_estacionamento`
--
DROP TABLE IF EXISTS `carros_estacionamento`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `carros_estacionamento`  AS  select `fluxo_diario`.`id_fluxo` AS `id_fluxo`,`fluxo_diario`.`carro` AS `carro`,`pagamentos_estacionamento`.`modalidade` AS `modalidade`,`fluxo_diario`.`pagamento` AS `pagamento`,`fluxo_diario`.`horario` AS `horario`,`v_horarios_estacionamento`.`id_horario` AS `id_horario`,`v_horarios_estacionamento`.`hora_entrada` AS `hora_entrada`,`v_horarios_estacionamento`.`hora_saida` AS `hora_saida`,`v_horarios_estacionamento`.`min_entrada` AS `min_entrada`,`v_horarios_estacionamento`.`min_saida` AS `min_saida`,`v_horarios_estacionamento`.`data_entrada` AS `data_entrada`,`v_horarios_estacionamento`.`data_saida` AS `data_saida`,`v_horarios_estacionamento`.`escritorio` AS `escritorio`,`v_horarios_estacionamento`.`id_visita` AS `id_visita`,`v_horarios_estacionamento`.`token` AS `token`,`v_horarios_estacionamento`.`created_at` AS `created_at`,`v_horarios_estacionamento`.`updated_at` AS `updated_at`,`v_horarios_estacionamento`.`usuario` AS `usuario`,`pagamentos_estacionamento`.`id_pagamento` AS `id_pagamento`,`pagamentos_estacionamento`.`valor` AS `valor`,`pagamentos_estacionamento`.`desconto` AS `desconto`,`pagamentos_estacionamento`.`justificativa_desconto` AS `justificativa_desconto`,`pagamentos_estacionamento`.`base_calculo` AS `base_calculo`,`pagamentos_estacionamento`.`pago` AS `pago` from ((`fluxo_diario` join `v_horarios_estacionamento` on(`fluxo_diario`.`horario` = `v_horarios_estacionamento`.`id_horario`)) left join `pagamentos_estacionamento` on(`fluxo_diario`.`pagamento` = `pagamentos_estacionamento`.`id_pagamento`)) ;

-- --------------------------------------------------------

--
-- Structure for view `mensalistas`
--
DROP TABLE IF EXISTS `mensalistas`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `mensalistas`  AS  select `carros_estacionamento`.`id_fluxo` AS `id_fluxo`,`carros_estacionamento`.`carro` AS `carro`,`carros_estacionamento`.`modalidade` AS `modalidade`,`carros_estacionamento`.`pagamento` AS `pagamento`,`carros_estacionamento`.`horario` AS `horario`,`carros_estacionamento`.`id_horario` AS `id_horario`,`carros_estacionamento`.`hora_entrada` AS `hora_entrada`,`carros_estacionamento`.`hora_saida` AS `hora_saida`,`carros_estacionamento`.`min_entrada` AS `min_entrada`,`carros_estacionamento`.`min_saida` AS `min_saida`,`carros_estacionamento`.`data_entrada` AS `data_entrada`,`carros_estacionamento`.`data_saida` AS `data_saida`,`carros_estacionamento`.`escritorio` AS `escritorio`,`carros_estacionamento`.`id_visita` AS `id_visita`,`carros_estacionamento`.`token` AS `token`,`carros_estacionamento`.`created_at` AS `created_at`,`carros_estacionamento`.`updated_at` AS `updated_at`,`carros_estacionamento`.`usuario` AS `usuario`,`carros_estacionamento`.`id_pagamento` AS `id_pagamento`,`carros_estacionamento`.`valor` AS `valor`,`carros_estacionamento`.`desconto` AS `desconto`,`carros_estacionamento`.`justificativa_desconto` AS `justificativa_desconto`,`carros_estacionamento`.`base_calculo` AS `base_calculo`,`carros_estacionamento`.`pago` AS `pago` from `carros_estacionamento` where `carros_estacionamento`.`modalidade` = 'mensalidade' and `carros_estacionamento`.`data_saida` >= curdate() ;

-- --------------------------------------------------------

--
-- Structure for view `meus_dizimistas`
--
DROP TABLE IF EXISTS `meus_dizimistas`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `meus_dizimistas`  AS  select `dizimistas`.`id_dizimista` AS `id_dizimista`,`dizimistas`.`pessoa` AS `pessoa`,`dizimistas`.`d_cadastro` AS `d_cadastro`,`dizimistas`.`situacao` AS `situacao`,`pessoas`.`id_pessoa` AS `id_pessoa`,`telefones`.`dd` AS `dd`,`telefones`.`id_telefone` AS `id_telefone`,`telefones`.`numero` AS `numero`,`telefones`.`obs` AS `obs`,`pessoas`.`nome` AS `nome`,`pessoas`.`endereco` AS `endereco`,`pessoas`.`d_nasc` AS `d_nasc`,`pessoas`.`email` AS `email`,`pessoas`.`sexo` AS `sexo`,`enderecos`.`id_endereco` AS `id_endereco`,`enderecos`.`logradouro` AS `logradouro`,`enderecos`.`num_casa` AS `num_casa`,`enderecos`.`apartamento` AS `apartamento`,`enderecos`.`complemento` AS `complemento`,`enderecos`.`observacoes` AS `observacoes`,`logradouros`.`id_logradouro` AS `id_logradouro`,`logradouros`.`rua` AS `rua`,`logradouros`.`bairro` AS `bairro`,`logradouros`.`cep` AS `cep`,`logradouros`.`cidade` AS `cidade`,`logradouros`.`estado` AS `estado`,`estado`.`id_estado` AS `id_estado`,`estado`.`nome_estado` AS `nome_estado`,`estado`.`sigla` AS `sigla` from (((((`dizimistas` join `pessoas`) join `enderecos`) join `logradouros`) join `estado`) join `telefones`) where `dizimistas`.`pessoa` = `pessoas`.`id_pessoa` and `pessoas`.`endereco` = `enderecos`.`id_endereco` and `enderecos`.`logradouro` = `logradouros`.`id_logradouro` and `logradouros`.`estado` = `estado`.`id_estado` and `telefones`.`pessoa` = `pessoas`.`id_pessoa` ;

-- --------------------------------------------------------

--
-- Structure for view `registros_pessoas`
--
DROP TABLE IF EXISTS `registros_pessoas`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `registros_pessoas`  AS  select `pessoas`.`id_pessoa` AS `id_pessoa`,`pessoas`.`nome` AS `nome`,`pessoas`.`endereco` AS `endereco`,`pessoas`.`d_nasc` AS `d_nasc`,`pessoas`.`email` AS `email`,`pessoas`.`sexo` AS `sexo`,`pessoas`.`observacoes_pessoa` AS `observacoes_pessoa`,`telefones`.`id_telefone` AS `id_telefone`,`telefones`.`dd` AS `dd`,`telefones`.`numero` AS `numero`,`telefones`.`obs` AS `obs`,`telefones`.`pessoa` AS `pessoa`,`enderecos`.`id_endereco` AS `id_endereco`,`enderecos`.`logradouro` AS `logradouro`,`enderecos`.`num_casa` AS `num_casa`,`enderecos`.`apartamento` AS `apartamento`,`enderecos`.`complemento` AS `complemento`,`enderecos`.`observacoes` AS `observacoes`,`logradouros`.`id_logradouro` AS `id_logradouro`,`logradouros`.`rua` AS `rua`,`logradouros`.`bairro` AS `bairro`,`logradouros`.`cep` AS `cep`,`logradouros`.`cidade` AS `cidade`,`logradouros`.`estado` AS `estado`,`estado`.`id_estado` AS `id_estado`,`estado`.`nome_estado` AS `nome_estado`,`estado`.`sigla` AS `sigla` from ((((`pessoas` left join `telefones` on(`telefones`.`pessoa` = `pessoas`.`id_pessoa`)) left join `enderecos` on(`pessoas`.`endereco` = `enderecos`.`id_endereco`)) left join `logradouros` on(`logradouros`.`id_logradouro` = `enderecos`.`logradouro`)) left join `estado` on(`estado`.`id_estado` = `logradouros`.`estado`)) order by `pessoas`.`nome` ;

-- --------------------------------------------------------

--
-- Structure for view `v_horarios_estacionamento`
--
DROP TABLE IF EXISTS `v_horarios_estacionamento`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_horarios_estacionamento`  AS  (select `horario_estacionamento`.`id_horario` AS `id_horario`,`horario_estacionamento`.`hora_entrada` AS `hora_entrada`,`horario_estacionamento`.`hora_saida` AS `hora_saida`,`horario_estacionamento`.`min_entrada` AS `min_entrada`,`horario_estacionamento`.`min_saida` AS `min_saida`,`horario_estacionamento`.`data_entrada` AS `data_entrada`,`horario_estacionamento`.`data_saida` AS `data_saida`,`horario_estacionamento`.`escritorio` AS `escritorio`,`escritorio_visita_estacioanamento`.`id_visita` AS `id_visita`,`escritorio_visita_estacioanamento`.`token` AS `token`,`escritorio_visita_estacioanamento`.`created_at` AS `created_at`,`escritorio_visita_estacioanamento`.`updated_at` AS `updated_at`,`escritorio_visita_estacioanamento`.`usuario` AS `usuario` from (`horario_estacionamento` left join `escritorio_visita_estacioanamento` on(`horario_estacionamento`.`escritorio` = `escritorio_visita_estacioanamento`.`id_visita`))) ;

-- --------------------------------------------------------

--
-- Structure for view `v_pessoas`
--
DROP TABLE IF EXISTS `v_pessoas`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_pessoas`  AS  select `pessoas`.`id_pessoa` AS `id_pessoa`,`pessoas`.`nome` AS `nome`,`pessoas`.`endereco` AS `endereco`,`pessoas`.`d_nasc` AS `d_nasc`,`pessoas`.`email` AS `email`,`pessoas`.`sexo` AS `sexo`,`pessoas`.`observacoes_pessoa` AS `observacoes_pessoa`,`enderecos`.`id_endereco` AS `id_endereco`,`enderecos`.`logradouro` AS `logradouro`,`enderecos`.`num_casa` AS `num_casa`,`enderecos`.`apartamento` AS `apartamento`,`enderecos`.`complemento` AS `complemento`,`enderecos`.`observacoes` AS `observacoes`,`logradouros`.`id_logradouro` AS `id_logradouro`,`logradouros`.`rua` AS `rua`,`logradouros`.`bairro` AS `bairro`,`logradouros`.`cep` AS `cep`,`logradouros`.`cidade` AS `cidade`,`logradouros`.`estado` AS `estado`,`estado`.`id_estado` AS `id_estado`,`estado`.`nome_estado` AS `nome_estado`,`estado`.`sigla` AS `sigla` from (((`pessoas` left join `enderecos` on(`enderecos`.`id_endereco` = `pessoas`.`endereco`)) left join `logradouros` on(`logradouros`.`id_logradouro` = `enderecos`.`logradouro`)) left join `estado` on(`estado`.`id_estado` = `logradouros`.`estado`)) ;
...
--
-- Indexes for table `base_de_precos_estacionamento`
--
ALTER TABLE `base_de_precos_estacionamento`
  ADD PRIMARY KEY (`id_base_preco`);
...
--
-- Indexes for table `clero_igreja`
--
...
--
-- Indexes for table `escritorio_visita_estacioanamento`
--
ALTER TABLE `escritorio_visita_estacioanamento`
...
--
-- Indexes for table `fluxo_diario`
--
ALTER TABLE `fluxo_diario`
  ADD PRIMARY KEY (`id_fluxo`),
  ADD KEY `fk_carro__fluxo_diario` (`carro`),
  ADD KEY `fk_horario__fluxo_diario` (`horario`),
  ADD KEY `fk_pagamento__fluxo_diario` (`pagamento`);
...
--
-- Indexes for table `horario_estacionamento`
--
ALTER TABLE `horario_estacionamento`
  ADD PRIMARY KEY (`id_horario`),
  ADD KEY `fk_Visista_Escritorio__horarios` (`escritorio`);
...
ALTER TABLE `intencao`
  ...
  ADD KEY `fk_intencao__tipo_intecao` (`tipo`);
...
--
-- Indexes for table `pagamentos_estacionamento`
--
ALTER TABLE `pagamentos_estacionamento`
...
--
-- Indexes for table `precos_estacionamento`
--
ALTER TABLE `precos_estacionamento`
...
--
-- AUTO_INCREMENT for table `base_de_precos_estacionamento`
--
ALTER TABLE `base_de_precos_estacionamento`
  MODIFY `id_base_preco` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT for table `capelas`
--
ALTER TABLE `capelas`
...
--
-- AUTO_INCREMENT for table `clero`
--
ALTER TABLE `clero`
...
--
ALTER TABLE `computadores`
  MODIFY `id_computador` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `dizimistas`
  MODIFY `id_dizimista` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT for table `enderecos`
--
ALTER TABLE `enderecos`
  MODIFY `id_endereco` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT for table `escritorio_visita_estacioanamento`
--
ALTER TABLE `escritorio_visita_estacioanamento`
...
--
ALTER TABLE `estado`
  MODIFY `id_estado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
...
--
-- AUTO_INCREMENT for table `fluxo_diario`
--
ALTER TABLE `fluxo_diario`
  MODIFY `id_fluxo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
...
--
-- AUTO_INCREMENT for table `horario_estacionamento`
--
ALTER TABLE `horario_estacionamento`
...
--
ALTER TABLE `intencao`
  MODIFY `id_intencao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `logradouros`
  MODIFY `id_logradouro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
-- AUTO_INCREMENT for table `pagamentos_estacionamento`
--
ALTER TABLE `pagamentos_estacionamento`
  MODIFY `id_pagamento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
...
--
ALTER TABLE `pessoas`
  MODIFY `id_pessoa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=89;

--
-- AUTO_INCREMENT for table `precos_estacionamento`
--
ALTER TABLE `precos_estacionamento`
...
--
ALTER TABLE `veiculos`
  MODIFY `id_veiculo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=81;
...
--
-- Constraints for table `fluxo_diario`
--
ALTER TABLE `fluxo_diario`
  ADD CONSTRAINT `fk_carro__fluxo_diario` FOREIGN KEY (`carro`) REFERENCES `veiculos` (`id_veiculo`),
  ADD CONSTRAINT `fk_horario__fluxo_diario` FOREIGN KEY (`horario`) REFERENCES `horario_estacionamento` (`id_horario`),
  ADD CONSTRAINT `fk_pagamento__fluxo_diario` FOREIGN KEY (`pagamento`) REFERENCES `pagamentos_estacionamento` (`id_pagamento`);

--
-- Constraints for table `folhas`
--
ALTER TABLE `folhas`
  ADD CONSTRAINT `fk_livros_folhas` FOREIGN KEY (`livro`) REFERENCES `livros` (`id_livro`);

--
-- Constraints for table `fotos_folhas`
--
ALTER TABLE `fotos_folhas`
  ADD CONSTRAINT `fk_folhas_fotosFolhas` FOREIGN KEY (`folha`) REFERENCES `folhas` (`id_folha`);

--
-- Constraints for table `horario_estacionamento`
--
ALTER TABLE `horario_estacionamento`
  ADD CONSTRAINT `fk_Visista_Escritorio__horarios` FOREIGN KEY (`escritorio`) REFERENCES `escritorio_visita_estacioanamento` (`id_visita`);

--
-- Constraints for table `igrejas`
--
ALTER TABLE `igrejas`
  ADD CONSTRAINT `fk_endereco_igreja` FOREIGN KEY (`endereco`) REFERENCES `enderecos` (`id_endereco`);

--
-- Constraints for table `intencao`
--
ALTER TABLE `intencao`
  ADD CONSTRAINT `fk_intencao__tipo_intecao` FOREIGN KEY (`tipo`) REFERENCES `tipos_intencao` (`id_tipo`);
