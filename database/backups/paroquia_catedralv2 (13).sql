...
--
-- Host: 127.0.0.1
-- Generation Time: 27-Fev-2020 às 17:52
...
INSERT INTO `computadores` (`ip`, `nome`, `senha`, `descricao`, `mac`, `sistema_operacional`, `tipo`, `marca`) VALUES
('127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'desconhecido', NULL);
...
CREATE TABLE `precos_estacionamento` (
  ...
  `computador` int(11) DEFAULT NULL,
...
--
ALTER TABLE `base_de_precos_estacionamento`
  MODIFY `id_base_preco` int(11) NOT NULL AUTO_INCREMENT;
