...
(1, 16, NULL, 21, NULL, '2020-04-01', NULL, NULL),
(2, 14, NULL, 31, NULL, '2020-04-02', NULL, NULL),
(3, 14, NULL, 31, NULL, '2020-04-02', NULL, NULL),
(4, 14, NULL, 31, NULL, '2020-04-02', NULL, NULL),
(5, 13, NULL, 54, NULL, '2020-04-02', NULL, NULL),
(6, 12, NULL, 55, NULL, '2020-04-02', NULL, NULL),
(7, 9, NULL, 55, NULL, '2020-04-02', NULL, NULL),
(8, 8, NULL, 55, NULL, '2020-04-02', NULL, NULL),
(9, 8, NULL, 55, NULL, '2020-04-02', NULL, NULL),
...
(29, 10, NULL, 1, NULL, '2020-04-03', NULL, NULL),
(30, 12, NULL, 0, NULL, '2020-04-03', NULL, NULL),
(35, 17, NULL, 55, NULL, '2020-04-03', NULL, NULL);
...
(1, NULL, NULL, NULL, 3, NULL, NULL, 'hora'),
(2, NULL, NULL, NULL, 3, NULL, NULL, 'hora'),
(3, NULL, NULL, NULL, 3, NULL, NULL, 'pernoite'),
(4, NULL, NULL, NULL, 3, NULL, NULL, 'hora'),
(5, NULL, NULL, NULL, 3, NULL, NULL, 'hora'),
(6, NULL, NULL, NULL, 3, NULL, NULL, 'free'),
(7, NULL, NULL, NULL, 3, NULL, NULL, 'hora'),
(8, NULL, NULL, NULL, 3, NULL, NULL, 'hora'),
(9, NULL, NULL, NULL, 3, NULL, NULL, 'hora'),
...
(29, NULL, NULL, NULL, 3, NULL, NULL, 'hora'),
(30, NULL, NULL, NULL, 3, NULL, NULL, 'hora'),
(35, NULL, NULL, NULL, 3, NULL, NULL, 'hora');
...
(35, NULL, 'AAA-0009', NULL, NULL, NULL, 0, NULL, 'C'),
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_pessoas`  AS  select `pessoas`.`id_pessoa` AS `id_pessoa`,`pessoas`.`nome` AS `nome`,`pessoas`.`endereco` AS `endereco`,`pessoas`.`d_nasc` AS `d_nasc`,`pessoas`.`email` AS `email`,`pessoas`.`sexo` AS `sexo`,`pessoas`.`observacoes_pessoa` AS `observacoes_pessoa`,`enderecos`.`id_endereco` AS `id_endereco`,`enderecos`.`logradouro` AS `logradouro`,`enderecos`.`num_casa` AS `num_casa`,`enderecos`.`apartamento` AS `apartamento`,`enderecos`.`complemento` AS `complemento`,`enderecos`.`observacoes` AS `observacoes`,`telefones`.`id_telefone` AS `id_telefone`,`telefones`.`dd` AS `dd`,`telefones`.`numero` AS `numero`,`telefones`.`obs` AS `obs`,`telefones`.`pessoa` AS `pessoa` from ((`pessoas` left join `enderecos` on(`pessoas`.`endereco` = `enderecos`.`id_endereco`)) left join `telefones` on(`pessoas`.`id_pessoa` = `telefones`.`pessoa`)) order by `pessoas`.`nome` ;
...
--
ALTER TABLE `dizimistas`
  MODIFY `id_dizimista` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `fluxo_diario`
  MODIFY `id_fluxo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
...
--
ALTER TABLE `pessoas`
  MODIFY `id_pessoa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=73;
...
--
ALTER TABLE `telefones`
  MODIFY `id_telefone` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
...
--
ALTER TABLE `veiculos`
  MODIFY `id_veiculo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;
