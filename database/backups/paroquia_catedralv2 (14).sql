...
--
-- Host: 127.0.0.1
-- Generation Time: 16-Mar-2020 às 11:40
...
(1, '127.0.0.0', 'Servidor', NULL, NULL, NULL, NULL, 'desconhecido', NULL);
...
--
ALTER TABLE `dizimistas`
  MODIFY `id_dizimista` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `pessoas`
  MODIFY `id_pessoa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
