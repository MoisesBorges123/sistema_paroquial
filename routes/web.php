...
Route::post('/login/authentication','Auth\LoginController@authenticate')->name('login.authenticate');

Route::group(['prefix'=>'user/'],function(){    
    Route::get('register/create','Auth\RegisterController@create')->name('register');
...
Route::group(['prefix'=>'/painel//','middleware' => ['auth']],function(){
    ...
    Route::group(['prefix'=>'/pessoas//'],function(){
        Route::get('fetch/telefone/{numero?}','Painel\Pessoa\Pessoa@buscaTelefone')->name('Fetch.Telefone');
    ...
    Route::group(['prefix'=>'/dizimo//'],function(){
    ...
    Route::group(['prefix'=>'/diocese'],function(){
    ...
    Route::group(['prefix'=>'/missas'],function(){
    ...
    //ESTACIONAMENTO
    Route::group(['prefix'=>'/estacionamento'],function(){
        ...
        Route::post('/gerar-chave','Painel\Estacionamento\Estacionamento@keyGenerate')->name("CarrosEstacionados.Key");
        ...
        Route::get('/checking/key/{veiculo?}/{token?}','Painel\Estacionamento\Estacionamento@checkingToken')->name("CarrosEstacionados.CheckingKey");
       
        Route::group(['prefix'=>'/mensalidade'],function(){
            Route::post('/renovar','Painel\Estacionamento\Estacionamento@serMensalista')->name('Mensalidade.Renovar');
        });
    ...
    Route::group(['prefix'=>'/config/sistema'],function(){
        ...
        Route::group(['prefix'=>'/perfil//'],function(){
            Route::get('create','Painel\Configuracoes\Perfil\PerfilController@create')->name('Perfil.Create');
        });
